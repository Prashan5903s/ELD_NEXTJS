...
const ToggleSwitchDocument = ({ status, documentId, updateDocumentsList }) => {
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        try {
                            ...
                            const response = await axios.delete(`${url}/dashboard/documents/${documentId}`, {
                                headers: {
...
export default ToggleSwitchDocument;
