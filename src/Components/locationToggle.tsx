...
const ToggleSwitchLocation = ({ status, locationId, updateLocationsList }) => {
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        try {
                            ...
                            const response = await axios.delete(`${url}/asset/location/${locationId}`, {
                                headers: {
...
export default ToggleSwitchLocation;
